...
const styles = (window, layout) => StyleSheet.create({
  ...
  holesContainer: {
    ...
    height: '100%',
    borderRightWidth: 2,
    borderRightColor: colors.background.borderRed,
    alignItems: 'center',
  ...
  punchHole: {
    ...
    backgroundColor: colors.background.holeBlue,
  ...
  blueLine: {
    width: '100%',
    borderBottomWidth: 1,
    borderBottomColor: colors.background.lineBlue,
  },
  blueLineFirst: {
    width: '100%',
    borderTopWidth: 2,
    borderTopColor: colors.background.lineBlue,
    borderBottomWidth: 1,
    borderBottomColor: colors.background.lineBlue,
  },
});
